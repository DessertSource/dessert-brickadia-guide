...
- **Personal Information:** Information that falls under the category of personal data and can be used to identify an individual.
...
This site contains links to external websites in the footer and throughout various sections of the website. We are not responsible for the privacy practices or content of these third-party services.

Please consult the external websites' respective privacy policies for more information about the external websites we link to.

## Repository

Any contributions on the main repository of the Project may include traces of your email addresses and will become a permament part of the repository's Git history.

A Codeberg account is required to contribute to the repository, but contributors can use an existing GitHub account to make one. Please note that this process is subject to the [GitHub privacy policy](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement) and the [Codeberg privacy policy](https://codeberg.org/Codeberg/org/src/branch/main/PrivacyPolicy.md).

Due to the nature of the repository being hosted on Codeberg and mirrored to GitHub, you may not desire to include such information in your commits. In this case, hide your real email address in Codeberg's account settings.

## Contact

If you have privacy concerns or inquiries about our Project, please make a public issue on the main repository for this Project at [https://codeberg.org/DessertSource/dessert-brickadia-guide](https://codeberg.org/DessertSource/dessert-brickadia-guide).
