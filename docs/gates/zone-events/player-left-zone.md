---
icon: material/account-box-minus-outline
tags:
    - Wires
    - Gates
    - Zones
...
reference for every player or bot that leaves the zone.
...
and bots in collision channel 1 leave the zone.

### Player 2 Detection {{var_display("","boolean")}}

Whether to send an Exec signal and a player reference when players
and bots in collision channel 2 leave the zone.

### Player 3 Detection {{var_display("","boolean")}}

Whether to send an Exec signal and a player reference when players
and bots in collision channel 3 leave the zone.

### Player 4 Detection {{var_display("","boolean")}}

Whether to send an Exec signal and a player reference when players
and bots in collision channel 4 leave the zone.
