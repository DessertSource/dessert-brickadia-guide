...
This is a list of bricks under the _Micro-bricks_ category.

## Micro-Bricks

| Image                                                                                         | Display Name | Internal Name          | Resizable |
| --------------------------------------------------------------------------------------------- | ------------ | ---------------------- | --------- |
| ![Micro-Brick](../../assets/media/library/bricks/micro-bricks/micro-brick.png){.catalog-item} | Micro-Brick  | `PB_DefaultMicroBrick` | Yes       |
...
| Image                                                                                       | Display Name | Internal Name         | Resizable |
| ------------------------------------------------------------------------------------------- | ------------ | --------------------- | --------- |
| ![Micro-Ramp](../../assets/media/library/bricks/micro-bricks/micro-ramp.png){.catalog-item} | Micro-Ramp   | `PB_DefaultMicroRamp` | Yes       |

## Micro-Round Corners

| Image                                                                                                       | Display Name       | Internal Name                | Resizable |
| ----------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------- | --------- |
| ![Micro-Round Corner](../../assets/media/library/bricks/micro-bricks/micro-round-corner.png){.catalog-item} | Micro-Round Corner | `PB_DefaultMicroRoundCorner` | Yes       |

## Micro-Round Halves

| Image                                                                                                   | Display Name     | Internal Name              | Resizable |
| ------------------------------------------------------------------------------------------------------- | ---------------- | -------------------------- | --------- |
| ![Micro-Round Half](../../assets/media/library/bricks/micro-bricks/micro-round-half.png){.catalog-item} | Micro-Round Half | `PB_DefaultMicroRoundHalf` | Yes       |
